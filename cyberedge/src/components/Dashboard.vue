        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition duration-500">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl animate-number-scroll" :data-target="metrics.total_tasks">{{ metrics.total_tasks }}</p>
            </div>
          </div>
        </div>
        <!-- 卡片 2: 进行中的任务 -->
        <div class="bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition duration-500">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl animate-number-scroll" :data-target="metrics.in_progress_tasks">{{ metrics.in_progress_tasks }}</p>
            </div>
          </div>
        </div>
        <!-- 卡片 3: 完成的任务 -->
        <div class="bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition duration-500">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl animate-number-scroll" :data-target="metrics.completed_tasks">{{ metrics.completed_tasks }}</p>
            </div>
          </div>
        </div>
        <!-- 卡片 4: 失败的任务 -->
        <div class="bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition duration-500">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl animate-number-scroll" :data-target="metrics.failed_tasks">{{ metrics.failed_tasks }}</p>
            </div>
          </div>
        </div>
      </div>
