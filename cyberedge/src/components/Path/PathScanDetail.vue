    ...
    <div class="container mx-auto px-6 py-8 flex-1 mt-16">
      ...
      <div class="bg-gray-800/40 backdrop-blur-xl p-8 rounded-2xl shadow-2xl
        ...
        <div class="space-y-6 mb-8">
          <h2 class="text-xl font-medium tracking-wide text-gray-200">路径扫描详情</h2>
        ...
        <div class="relative overflow-x-auto rounded-xl">
          <table class="w-full">
            ...
            <tr v-for="path in paths"
              ...
              <td class="py-4 px-6 text-sm text-gray-200">{{ path.Status }}</td>
              <td class="py-4 px-6">
                  <span
                      class="px-2 py-1 rounded-full text-xs font-medium"
                      :class="path.IsRead ? 'bg-green-500/20 text-green-300' : 'bg-yellow-500/20 text-yellow-300'"
                  >
                    {{ path.IsRead ? '已读' : '未读' }}
                  </span>
              </td>
              <td class="py-4 px-6">
                <div class="flex space-x-2">
                  <button
                      ...
                      :class="path.IsRead ? 'bg-gray-700/50 text-gray-300' : 'bg-green-500/50 text-green-100'"
                  >
