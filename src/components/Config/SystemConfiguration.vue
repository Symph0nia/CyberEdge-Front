      ...
      >
        ...
        >
          <StatusCard
            ...
            class="bg-gray-900/50 backdrop-blur-sm border border-gray-700/30 rounded-xl p-6 transition-all duration-200 hover:bg-gray-900/70 hover:shadow-lg hover:border-gray-600/40"
          />
        </div>
